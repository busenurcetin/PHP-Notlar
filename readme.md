...
### [Tırnak İşaretleri Arasındaki Farklar](#tirnak)
...
# <h1 style="color:red;"> Web Teknolojileri Ve Programlama (PHP) Dersi Notlarım </h1>
...
`$dizi1 = array(1, 2, 3, "Buse Nur", "Ocak", "Şubat");`
